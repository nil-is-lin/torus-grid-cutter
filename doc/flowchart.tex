...
\begin{tikzpicture}[
    ...
    \node (assign) [module, below=of triang] {assign\_patch\_indices / assign\_connected\_components\_knot};
...
\begin{tikzpicture}[
    ...
    \node (res_v) [input, right=1.0cm of res_u] {Slider: V divisions (res\_v) / Point count};
...
\begin{tikzpicture}[
    ...
    \node (assign) [process, below=of cut_mesh] {assign\_patch\_indices / \_components\_knot};
